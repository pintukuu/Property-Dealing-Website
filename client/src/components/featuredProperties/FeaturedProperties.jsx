...
const FeaturedProperties = () => {
  const { data, error, loading } = useFetch("/props?featured=true&limit=4");
  // console.log(data);

  const images = ["https://cf.bstatic.com/xdata/images/hotel/square600/13125860.webp?k=e148feeb802ac3d28d1391dad9e4cf1e12d9231f897d0b53ca067bde8a9d3355&o=&s=1",
      ...
      {loading ? ("Loading please wait") : (<>
        {data.map((item) => (
          <div className="fpItem" key={item._id}>
            ...
            <span className="fpPrice">Starting from Rs{item.cheapestPrice
            }</span>
